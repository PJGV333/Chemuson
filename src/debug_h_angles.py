#!/usr/bin/env python3
"""Debug script for testing hydrogen angle calculations."""
...
# Simulate a simple zigzag chain
# First atom
canvas.model.add_atom('C', 100, 100)
# Second atom (30 degrees down-right for zigzag)
canvas.model.add_atom('C', 140, 120)
# Third atom (30 degrees up-right)
