"""Script de verificación visual para el renderizado de anillos y etiquetas."""
...
def verify_benzene_rendering():
    ...
    Side Effects:
        Crea un `QApplication`, dibuja en un `ChemusonCanvas`, guarda un archivo
        temporal y lo elimina al final.
    """
    app = QApplication(sys.argv)
    canvas = ChemusonCanvas()
    canvas.state.show_implicit_carbons = True
    
    # 1. Crear benceno manualmente (posiciones aproximadas en hexágono).
    atoms = [
    ...
    # Añadir enlaces alternados y asignar ring_id para el anillo.
    ring_id = 1 
    ...
    # Construir elementos visuales iniciales.
    canvas._rebuild_items_from_model()
    
    # Verificar cálculo del centro del anillo.
    ...
    # Verificar desplazamientos de dobles enlaces.
    ...
    # 2. Guardar y cargar archivo temporal.
    ...
    # 3. Verificar etiquetas y recortes (shrink).
