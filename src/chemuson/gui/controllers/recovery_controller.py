...
import chemuson.resilience.recovery as recovery_policy
...
class RecoveryController:
    ...
    def read_autosave_metadata(filepath: str) -> Optional[dict]:
        return recovery_policy.read_autosave_metadata(filepath)

    @staticmethod
    def list_autosave_entries(directory: str) -> list[dict]:
        return recovery_policy.list_autosave_entries(directory)

    @staticmethod
    def archive_autosave(path: str, autosave_dir: str) -> str:
        return recovery_policy.archive_autosave(path, autosave_dir)
