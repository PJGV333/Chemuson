...
from chemuson.compchem.exporters import (
...
class ChemusonWindow(QMainWindow):
    ...
    # -------------------------------------------------------------------------
    _coords_center = staticmethod(coords_center)
    _average_bond_length = staticmethod(average_bond_length)
    _rescale_coords_to_bond_length = staticmethod(rescale_coords_to_bond_length)
    _align_coords_to_reference = staticmethod(align_coords_to_reference)
    _project_missing_hydrogen_coords = staticmethod(
        project_missing_hydrogen_coords
    )
