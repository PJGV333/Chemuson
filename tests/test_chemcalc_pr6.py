...
from chemuson.chemcalc import molecular_formula, format_formula, molecular_weight
...
class ChemCalcPR6Test(unittest.TestCase):
    ...
    def test_bromo_chloro_dodecane_formula(self):
        ...
        formula = molecular_formula(graph)
        self.assertEqual(format_formula(formula), "C12H24BrCl")
        self.assertTrue(molecular_weight(formula) > 0.0)
