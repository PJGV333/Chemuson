# clean-2d-campaign2-topology-decomposition Specification

## Purpose
This capability provides deterministic, JSON-safe topology and decomposition
evidence over ChemUSON's existing multilayer and block graph models without
changing Clean2D geometry or candidate selection.
